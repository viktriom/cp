 ...
 *
 */
@ExecutableCommand(commandDescription = "Sets the context from which the command is to be executed.", commandParams = {"index 0"}, commandParamsDescription = {"The new command context"})
